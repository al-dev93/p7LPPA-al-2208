...
class RecipeCard{
    ...
    searchControl() {
        this.card.addEventListener('search-enable', () => this.card.classList.remove('d-none'));
        this.card.addEventListener('search-disable', () => this.card.classList.add('d-none'));
    }
    //FIXME tester sur les idRecipes et non sur les keys
